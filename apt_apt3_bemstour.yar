...
$chunk_1 = {C7 45 ?? 55 8B EC 83}
$chunk_2 = {C7 45 ?? EC 74 53 56}
$chunk_3 = {C7 45 ?? 8B 75 08 33}
$chunk_4 = {C7 45 ?? C9 57 C7 45}
$chunk_5 = {C7 45 ?? 8C 4C 6F 61}
...
$chunk_1 = {C7 85 ?? ?? ?? ?? 63 6D 64 2E}
$chunk_2 = {C7 85 ?? ?? ?? ?? 65 78 65 20}
$chunk_3 = {C7 85 ?? ?? ?? ?? 2F 63 20 63}
$chunk_4 = {C7 85 ?? ?? ?? ?? 6F 70 79 20}
$chunk_5 = {C7 85 ?? ?? ?? ?? 25 77 69 6E}
$chunk_6 = {C7 85 ?? ?? ?? ?? 64 69 72 25}
